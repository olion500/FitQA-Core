...
import com.cocovo.fitqaspringjava.interfaces.trainer.dto.TrainerDto.TrainerWithFeedback;
...
public interface TrainerDtoMapper {
  ...
  TrainerWithFeedback of(TrainerInfo.TrainerWithFeedback trainerInfo);
